...
var popCornSprite = '../assets/images/ennemies.png'
var shipSprite = '../assets/images/character.png'
...
Player.prototype.render = function(context) {
  ...
  context.drawImage(
    this.img, 0, this.frame * 0, 900, 640,
    this.x, this.y, this.width, this.height
  )
...
Popcorn.prototype.render = function(context) {
  ...
  context.drawImage(
    this.img, 0, this.currentFrame * 0, 1409, 731,
    this.x, this.y, this.width, this.height
  )
